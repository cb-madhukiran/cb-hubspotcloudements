...
let modifiedFieldsJson = steps.SaveFieldsInputParams.syncRuleForFields;
let existingFieldsJson = lastConfig.syncRulesFields;
 console.log("existingFieldsJson:"+existingFieldsJson);
console.log("modifiedFieldsJson:"+modifiedFieldsJson);
...
if (existingFieldsJson.contact === undefined)
{
  console.log("contact is empty");
}
if (modifiedFieldsJson.contact === undefined)
{
   console.log("contact update is empty");
}
console.log(existingFieldsJson.contact);
console.log(modifiedFieldsJson.contact);
