...
let list = steps.CBCustomFields.response.body;
...
if(list!==undefined){
  ...
  for(var i=0;i<list.length;i++){
    ...
    let syncRulesFields = steps.NewChargebeeConfigParams.response.body.third_party_configuration.config_json.cloudElements.syncRulesFields;
